...
% Plot runtime and memory against nodes
\begin{figure}[H]
  \centering
...
\subsection{Louvain}
\textit{Louvain} method (\ref{sec:louvain_method}) is a heuristic method that is based on modularity optimization (\ref{sec:modularity_maximization}). In \cite{ref-27}, Blondel et al. claimed that louvain method outperforms all other known community detection algorithm in terms of computation time. Moreover, the quality of detected communities is very good, as measured by modularity.
